...
if __name__ == "__main__":
    ...
    parser.add_argument("--scene_dir_path", default="images/", type=str)
    parser.add_argument("--mask_dir_path", default="masks/", type=str)
    parser.add_argument("--save_dir_path", default="clips/", type=str)
