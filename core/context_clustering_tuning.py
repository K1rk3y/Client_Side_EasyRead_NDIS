...
def objective(trial):
    ...
    config = {
        ...
        "ngram_range": trial.suggest_categorical(
            "ngram_range", [(1, 1), (1, 2), (1, 3), (2, 3), (2, 2), (3, 3)]
        ),
...
def tune_hyperparameters(
    sentences, n_trials=100, timeout=3600, show_progress_bar=True  # 1 hour timeout
):
    """
    ...
    return {"best_params": trial.params, "best_score": trial.value}
